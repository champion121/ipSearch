...
//		System.out.println(ipToLong("124.236.133.61"));
//		System.out.println(longToIP(2095875389l));
		System.out.println(isIP("124.236.133.61"));
		System.out.println(isIP("124.236.133"));
	}
}